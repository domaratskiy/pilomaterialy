...
$opt_name = 'header_option';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'текстовые настройки', 'your-textdomain-here' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'текстовые настройки', 'your-textdomain-here' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Настройки', 'your-textdomain-here' ),
		'id'               => 'basic',
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Шапка сайта', 'your-textdomain-here' ),
		...
		'fields'           => array(
			array(
				...
				'desc'     => esc_html__( 'Укажите текст логотипа', 'your-textdomain-here' ),				
			),
			array(
				'id'       => 'header-title',
				'type'     => 'text',
				'title'    => esc_html__( 'Заглавие Шапки', 'your-textdomain-here' ),
				'desc'     => esc_html__( 'Укажите текст Заглавия', 'your-textdomain-here' ),				
			),
			array(
				'id'       => 'header-workTime1',
				'type'     => 'text',
				'title'    => esc_html__( 'Время работы будни', 'your-textdomain-here' ),
				'desc'     => esc_html__( 'Укажите время работы', 'your-textdomain-here' ),			
			),
			array(
				'id'       => 'header-workTime2',
				'type'     => 'text',
				'title'    => esc_html__( 'Время работы выходные', 'your-textdomain-here' ),
				'desc'     => esc_html__( 'Укажите время работы', 'your-textdomain-here' ),				
			),
			array(
				'id'       => 'header-number3',
				'type'     => 'text',
				'title'    => esc_html__( 'номер 1 телефона Влада', 'your-textdomain-here' ),
				'desc'     => esc_html__( 'Введите номер Влада', 'your-textdomain-here' ),				
			),
			array(
				'id'       => 'header-number1',
				'type'     => 'text',
				'title'    => esc_html__( 'номер 2 телефона Влада', 'your-textdomain-here' ),
				'desc'     => esc_html__( 'Введите номер Влада', 'your-textdomain-here' ),				
			),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Подвал сайта', 'your-textdomain-here' ),
		'id'               => 'footerInfo',
		'subsection'       => true,
		'customizer_width' => '700px',
		'fields'           => array(
			...
			array(
				'id'       => 'footer_text',
				'type'     => 'text',
				'title'    => esc_html__( 'Описание деятельности компании', 'your-textdomain-here' ),
				'desc'     => esc_html__( 'Введите текст', 'your-textdomain-here' ),				
			),
			array(
				'id'       => 'footer_infoAdress',
				'type'     => 'text',
				'title'    => esc_html__( 'описание деятельности компании', 'your-textdomain-here' ),
				'desc'     => esc_html__( 'Введите текст', 'your-textdomain-here' ),				
			),
			array(
				'id'       => 'footer_infoSocial1',
				'type'     => 'text',
				'title'    => esc_html__( 'Введите URL инстаграма', 'your-textdomain-here' ),				
			),
			array(
				'id'       => 'footer_infoSocial2',
				'type'     => 'text',
				'title'    => esc_html__( 'Введите URL Фейсбука', 'your-textdomain-here' ),				
			),
			array(
				'id'       => 'footer_email',
				'type'     => 'text',
				'title'    => esc_html__( 'Введите електронную почту', 'your-textdomain-here' ),				
			),
		),
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Страница информация + доставка', 'your-textdomain-here' ),
		'id'               => 'deliveryInfo',
		'subsection'       => true,
		'customizer_width' => '700px',
		'fields'           => array(
			array(
				'id'       => 'delivery-text-title',
				'type'     => 'text',
				'title'    => esc_html__( 'Заглавие экрана информации и доставки', 'your-textdomain-here' ),
				'desc'     => esc_html__( 'Укажите текст', 'your-textdomain-here' ),				
			),
			array(
				'id'       => 'delivery-text-subTitle',
				'type'     => 'textarea',
				'title'    => esc_html__( 'Описание компании', 'your-textdomain-here' ),
				'desc'     => esc_html__( 'Укажите текст', 'your-textdomain-here' ),				
			),
			array(
				'id'       => 'delivery-text-productTitle',
				'type'     => 'textarea',
				'title'    => esc_html__( 'Ваши товары', 'your-textdomain-here' ),
				'desc'     => esc_html__( 'Укажите текст в формате <li>текст</li>', 'your-textdomain-here' ),				
			),
			array(
				'id'       => 'delivery-name',
				'type'     => 'text',
				'title'    => esc_html__( 'Укажите текст секции доставки', 'your-textdomain-here' ),
				'desc'     => esc_html__( 'Укажите текст', 'your-textdomain-here' ),				
			),
			array(
				'id'       => 'delivery-info',
			...
			array(
				'id'       => 'delivery-life',
				'type'     => 'text',
				'title'    => esc_html__( 'Укажите текст О нас', 'your-textdomain-here' ),
				'desc'     => esc_html__( 'Укажите текст', 'your-textdomain-here' ),				
			),
		),
	)
